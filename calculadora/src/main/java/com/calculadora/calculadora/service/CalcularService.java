...
// Quem conta a lógica de negócio da aplicação é a classe de serviço, ou seja, ela é responsável por realizar as operações matemáticas e retornar os resultados para o controlador.
//  O controlador, por sua vez, é responsável por receber as requisições HTTP, chamar os métodos do serviço e retornar as respostas para o cliente. 
// A separação entre controlador e serviço é uma boa prática de design de software, pois permite uma melhor organização do código e facilita a manutenção e evolução da aplicação.
